/* soapClient.c
   Generated by gSOAP 2.8.74 for discovery.wsdl.h
...
SOAP_SOURCE_STAMP("@(#) soapClient.c ver 2.8.74 2018-12-26 03:51:07 GMT")
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call___discovery__Hello(struct soap *soap, const char *soap_endpoint, const char *soap_action, struct wsdd__HelloType discovery__Hello, struct wsdd__ResolveType *discovery__HelloResponse)
{	struct __discovery__Hello soap_tmp___discovery__Hello;
	if (soap_action == NULL)
		soap_action = "http://www.onvif.org/ver10/network/wsdl/Hello";
	soap_tmp___discovery__Hello.discovery__Hello = discovery__Hello;
	soap_begin(soap);
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize___discovery__Hello(soap, &soap_tmp___discovery__Hello);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___discovery__Hello(soap, &soap_tmp___discovery__Hello, "-discovery:Hello", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_wsdd__ResolveType(soap, discovery__HelloResponse, "discovery:HelloResponse", NULL);
	if (soap->error)
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call___discovery__Bye(struct soap *soap, const char *soap_endpoint, const char *soap_action, struct wsdd__ByeType discovery__Bye, struct wsdd__ResolveType *discovery__ByeResponse)
{	struct __discovery__Bye soap_tmp___discovery__Bye;
	if (soap_action == NULL)
		soap_action = "http://www.onvif.org/ver10/network/wsdl/Bye";
	soap_tmp___discovery__Bye.discovery__Bye = discovery__Bye;
	soap_begin(soap);
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize___discovery__Bye(soap, &soap_tmp___discovery__Bye);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___discovery__Bye(soap, &soap_tmp___discovery__Bye, "-discovery:Bye", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_wsdd__ResolveType(soap, discovery__ByeResponse, "discovery:ByeResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call___discovery__Probe(struct soap *soap, const char *soap_endpoint, const char *soap_action, struct wsdd__ProbeType discovery__Probe, struct wsdd__ProbeMatchesType *discovery__ProbeResponse)
{	struct __discovery__Probe soap_tmp___discovery__Probe;
	if (soap_action == NULL)
		soap_action = "http://www.onvif.org/ver10/network/wsdl/Probe";
	soap_tmp___discovery__Probe.discovery__Probe = discovery__Probe;
	soap_begin(soap);
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize___discovery__Probe(soap, &soap_tmp___discovery__Probe);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___discovery__Probe(soap, &soap_tmp___discovery__Probe, "-discovery:Probe", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_wsdd__ProbeMatchesType(soap, discovery__ProbeResponse, "discovery:ProbeResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
