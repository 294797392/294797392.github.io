/* soapH.h
   Generated by gSOAP 2.8.74 for server/discovery/discovery.wsdl.h
...
#ifndef SOAP_TYPE___discovery__Probe_DEFINED
#define SOAP_TYPE___discovery__Probe_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default___discovery__Probe(struct soap*, struct __discovery__Probe *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___discovery__Probe(struct soap*, const struct __discovery__Probe *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out___discovery__Probe(struct soap*, const char*, int, const struct __discovery__Probe *, const char*);
SOAP_FMAC3 struct __discovery__Probe * SOAP_FMAC4 soap_in___discovery__Probe(struct soap*, const char*, struct __discovery__Probe *, const char*);

SOAP_FMAC3 struct __discovery__Probe * SOAP_FMAC4 soap_new___discovery__Probe(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put___discovery__Probe(struct soap*, const struct __discovery__Probe *, const char*, const char*);

#ifndef soap_write___discovery__Probe
#define soap_write___discovery__Probe(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize___discovery__Probe(soap, data), 0) || soap_put___discovery__Probe(soap, data, "-discovery:Probe", "") || soap_end_send(soap), (soap)->error )
#endif


#ifndef soap_PUT___discovery__Probe
#define soap_PUT___discovery__Probe(soap, URL, data) ( soap_free_temp(soap), soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize___discovery__Probe(soap, data), 0) || soap_put___discovery__Probe(soap, data, "-discovery:Probe", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_PATCH___discovery__Probe
#define soap_PATCH___discovery__Probe(soap, URL, data) ( soap_free_temp(soap), soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize___discovery__Probe(soap, data), 0) || soap_put___discovery__Probe(soap, data, "-discovery:Probe", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_POST_send___discovery__Probe
#define soap_POST_send___discovery__Probe(soap, URL, data) ( soap_free_temp(soap), ( soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize___discovery__Probe(soap, data), 0) || soap_put___discovery__Probe(soap, data, "-discovery:Probe", "") || soap_end_send(soap) ) && soap_closesock(soap), (soap)->error )
#endif

SOAP_FMAC3 struct __discovery__Probe * SOAP_FMAC4 soap_get___discovery__Probe(struct soap*, struct __discovery__Probe *, const char*, const char*);

#ifndef soap_read___discovery__Probe
#define soap_read___discovery__Probe(soap, data) ( ((data) ? (soap_default___discovery__Probe(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get___discovery__Probe(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif


#ifndef soap_GET___discovery__Probe
#define soap_GET___discovery__Probe(soap, URL, data) ( soap_GET(soap, URL, NULL) || soap_read___discovery__Probe(soap, (data)), soap_closesock(soap) )
#endif


#ifndef soap_POST_recv___discovery__Probe
#define soap_POST_recv___discovery__Probe(soap, data) ( soap_read___discovery__Probe(soap, (data)) || soap_closesock(soap), (soap)->error )
#endif

#endif

#ifndef SOAP_TYPE___discovery__Bye_DEFINED
#define SOAP_TYPE___discovery__Bye_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default___discovery__Bye(struct soap*, struct __discovery__Bye *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___discovery__Bye(struct soap*, const struct __discovery__Bye *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out___discovery__Bye(struct soap*, const char*, int, const struct __discovery__Bye *, const char*);
SOAP_FMAC3 struct __discovery__Bye * SOAP_FMAC4 soap_in___discovery__Bye(struct soap*, const char*, struct __discovery__Bye *, const char*);

SOAP_FMAC3 struct __discovery__Bye * SOAP_FMAC4 soap_new___discovery__Bye(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put___discovery__Bye(struct soap*, const struct __discovery__Bye *, const char*, const char*);

#ifndef soap_write___discovery__Bye
#define soap_write___discovery__Bye(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize___discovery__Bye(soap, data), 0) || soap_put___discovery__Bye(soap, data, "-discovery:Bye", "") || soap_end_send(soap), (soap)->error )
#endif


#ifndef soap_PUT___discovery__Bye
#define soap_PUT___discovery__Bye(soap, URL, data) ( soap_free_temp(soap), soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize___discovery__Bye(soap, data), 0) || soap_put___discovery__Bye(soap, data, "-discovery:Bye", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_PATCH___discovery__Bye
#define soap_PATCH___discovery__Bye(soap, URL, data) ( soap_free_temp(soap), soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize___discovery__Bye(soap, data), 0) || soap_put___discovery__Bye(soap, data, "-discovery:Bye", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_POST_send___discovery__Bye
#define soap_POST_send___discovery__Bye(soap, URL, data) ( soap_free_temp(soap), ( soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize___discovery__Bye(soap, data), 0) || soap_put___discovery__Bye(soap, data, "-discovery:Bye", "") || soap_end_send(soap) ) && soap_closesock(soap), (soap)->error )
#endif

SOAP_FMAC3 struct __discovery__Bye * SOAP_FMAC4 soap_get___discovery__Bye(struct soap*, struct __discovery__Bye *, const char*, const char*);

#ifndef soap_read___discovery__Bye
#define soap_read___discovery__Bye(soap, data) ( ((data) ? (soap_default___discovery__Bye(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get___discovery__Bye(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif


#ifndef soap_GET___discovery__Bye
#define soap_GET___discovery__Bye(soap, URL, data) ( soap_GET(soap, URL, NULL) || soap_read___discovery__Bye(soap, (data)), soap_closesock(soap) )
#endif


#ifndef soap_POST_recv___discovery__Bye
#define soap_POST_recv___discovery__Bye(soap, data) ( soap_read___discovery__Bye(soap, (data)) || soap_closesock(soap), (soap)->error )
#endif

#endif

#ifndef SOAP_TYPE___discovery__Hello_DEFINED
#define SOAP_TYPE___discovery__Hello_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default___discovery__Hello(struct soap*, struct __discovery__Hello *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___discovery__Hello(struct soap*, const struct __discovery__Hello *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out___discovery__Hello(struct soap*, const char*, int, const struct __discovery__Hello *, const char*);
SOAP_FMAC3 struct __discovery__Hello * SOAP_FMAC4 soap_in___discovery__Hello(struct soap*, const char*, struct __discovery__Hello *, const char*);

SOAP_FMAC3 struct __discovery__Hello * SOAP_FMAC4 soap_new___discovery__Hello(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put___discovery__Hello(struct soap*, const struct __discovery__Hello *, const char*, const char*);

#ifndef soap_write___discovery__Hello
#define soap_write___discovery__Hello(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize___discovery__Hello(soap, data), 0) || soap_put___discovery__Hello(soap, data, "-discovery:Hello", "") || soap_end_send(soap), (soap)->error )
#endif


#ifndef soap_PUT___discovery__Hello
#define soap_PUT___discovery__Hello(soap, URL, data) ( soap_free_temp(soap), soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize___discovery__Hello(soap, data), 0) || soap_put___discovery__Hello(soap, data, "-discovery:Hello", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_PATCH___discovery__Hello
#define soap_PATCH___discovery__Hello(soap, URL, data) ( soap_free_temp(soap), soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize___discovery__Hello(soap, data), 0) || soap_put___discovery__Hello(soap, data, "-discovery:Hello", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_POST_send___discovery__Hello
#define soap_POST_send___discovery__Hello(soap, URL, data) ( soap_free_temp(soap), ( soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize___discovery__Hello(soap, data), 0) || soap_put___discovery__Hello(soap, data, "-discovery:Hello", "") || soap_end_send(soap) ) && soap_closesock(soap), (soap)->error )
#endif

SOAP_FMAC3 struct __discovery__Hello * SOAP_FMAC4 soap_get___discovery__Hello(struct soap*, struct __discovery__Hello *, const char*, const char*);

#ifndef soap_read___discovery__Hello
#define soap_read___discovery__Hello(soap, data) ( ((data) ? (soap_default___discovery__Hello(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get___discovery__Hello(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif


#ifndef soap_GET___discovery__Hello
#define soap_GET___discovery__Hello(soap, URL, data) ( soap_GET(soap, URL, NULL) || soap_read___discovery__Hello(soap, (data)), soap_closesock(soap) )
#endif


#ifndef soap_POST_recv___discovery__Hello
#define soap_POST_recv___discovery__Hello(soap, data) ( soap_read___discovery__Hello(soap, (data)) || soap_closesock(soap), (soap)->error )
#endif
