...
SOAP_SOURCE_STAMP("@(#) soapServer.c ver 2.8.74 2018-12-21 09:48:42 GMT")
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_request(struct soap *soap)
{
	...
	if (!soap_match_tag(soap, soap->tag, "discovery:Hello"))
		return soap_serve___discovery__Hello(soap);
	if (!soap_match_tag(soap, soap->tag, "discovery:Bye"))
		return soap_serve___discovery__Bye(soap);
	if (!soap_match_tag(soap, soap->tag, "discovery:Probe"))
		return soap_serve___discovery__Probe(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___discovery__Hello(struct soap *soap)
{	struct __discovery__Hello soap_tmp___discovery__Hello;
	struct wsdd__ResolveType discovery__HelloResponse;
	soap_default_wsdd__ResolveType(soap, &discovery__HelloResponse);
	soap_default___discovery__Hello(soap, &soap_tmp___discovery__Hello);
	if (!soap_get___discovery__Hello(soap, &soap_tmp___discovery__Hello, "-discovery:Hello", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __discovery__Hello(soap, soap_tmp___discovery__Hello.discovery__Hello, &discovery__HelloResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize_wsdd__ResolveType(soap, &discovery__HelloResponse);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put_wsdd__ResolveType(soap, &discovery__HelloResponse, "discovery:HelloResponse", "")
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___discovery__Bye(struct soap *soap)
{	struct __discovery__Bye soap_tmp___discovery__Bye;
	struct wsdd__ResolveType discovery__ByeResponse;
	soap_default_wsdd__ResolveType(soap, &discovery__ByeResponse);
	soap_default___discovery__Bye(soap, &soap_tmp___discovery__Bye);
	if (!soap_get___discovery__Bye(soap, &soap_tmp___discovery__Bye, "-discovery:Bye", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __discovery__Bye(soap, soap_tmp___discovery__Bye.discovery__Bye, &discovery__ByeResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize_wsdd__ResolveType(soap, &discovery__ByeResponse);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_wsdd__ResolveType(soap, &discovery__ByeResponse, "discovery:ByeResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___discovery__Probe(struct soap *soap)
{	struct __discovery__Probe soap_tmp___discovery__Probe;
	struct wsdd__ProbeMatchesType discovery__ProbeResponse;
	soap_default_wsdd__ProbeMatchesType(soap, &discovery__ProbeResponse);
	soap_default___discovery__Probe(soap, &soap_tmp___discovery__Probe);
	if (!soap_get___discovery__Probe(soap, &soap_tmp___discovery__Probe, "-discovery:Probe", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __discovery__Probe(soap, soap_tmp___discovery__Probe.discovery__Probe, &discovery__ProbeResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize_wsdd__ProbeMatchesType(soap, &discovery__ProbeResponse);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_wsdd__ProbeMatchesType(soap, &discovery__ProbeResponse, "discovery:ProbeResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
