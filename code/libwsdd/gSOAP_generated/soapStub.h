...
#define SOAP_NAMESPACE_OF_discovery	"http://www.onvif.org/ver10/network/wsdl"
...
struct __discovery__Hello;	/* server/discovery/discovery.wsdl.h:296 */
struct __discovery__Bye;	/* server/discovery/discovery.wsdl.h:351 */
struct __discovery__Probe;	/* server/discovery/discovery.wsdl.h:406 */
...
/* server/discovery/discovery.wsdl.h:296 */
#ifndef SOAP_TYPE___discovery__Hello
#define SOAP_TYPE___discovery__Hello (99)
/* Wrapper: */
struct __discovery__Hello {
        /** Required element 'discovery:Hello' of XML schema type 'wsdd:HelloType' */
        struct wsdd__HelloType discovery__Hello;
};
#endif

/* server/discovery/discovery.wsdl.h:351 */
#ifndef SOAP_TYPE___discovery__Bye
#define SOAP_TYPE___discovery__Bye (101)
/* Wrapper: */
struct __discovery__Bye {
        /** Required element 'discovery:Bye' of XML schema type 'wsdd:ByeType' */
        struct wsdd__ByeType discovery__Bye;
};
#endif

/* server/discovery/discovery.wsdl.h:406 */
#ifndef SOAP_TYPE___discovery__Probe
#define SOAP_TYPE___discovery__Probe (103)
/* Wrapper: */
struct __discovery__Probe {
        /** Required element 'discovery:Probe' of XML schema type 'wsdd:ProbeType' */
        struct wsdd__ProbeType discovery__Probe;
};
#endif
...
\******************************************************************************/
    ...
    /** Web service operation '__discovery__Hello' (returns SOAP_OK or error code) */
    SOAP_FMAC5 int SOAP_FMAC6 __discovery__Hello(struct soap*, struct wsdd__HelloType discovery__Hello, struct wsdd__ResolveType *discovery__HelloResponse);
    /** Web service operation '__discovery__Bye' (returns SOAP_OK or error code) */
    SOAP_FMAC5 int SOAP_FMAC6 __discovery__Bye(struct soap*, struct wsdd__ByeType discovery__Bye, struct wsdd__ResolveType *discovery__ByeResponse);
    /** Web service operation '__discovery__Probe' (returns SOAP_OK or error code) */
    SOAP_FMAC5 int SOAP_FMAC6 __discovery__Probe(struct soap*, struct wsdd__ProbeType discovery__Probe, struct wsdd__ProbeMatchesType *discovery__ProbeResponse);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___discovery__Hello(struct soap*);

SOAP_FMAC5 int SOAP_FMAC6 soap_serve___discovery__Bye(struct soap*);

SOAP_FMAC5 int SOAP_FMAC6 soap_serve___discovery__Probe(struct soap*);
