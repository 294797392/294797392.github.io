...
SOAP_SOURCE_STAMP("@(#) soapC.c ver 2.8.74 2018-12-21 09:48:42 GMT")
...
{	(void)tag;
	...
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_putelement '%s' failed for type %d in server/discovery/soapC.c\n", tag ? tag : "", type));
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	switch (type)
	{
	case SOAP_TYPE___discovery__Probe:
		soap_serialize___discovery__Probe(soap, (const struct __discovery__Probe *)ptr);
		break;
	case SOAP_TYPE___discovery__Bye:
		soap_serialize___discovery__Bye(soap, (const struct __discovery__Bye *)ptr);
		break;
	case SOAP_TYPE___discovery__Hello:
		soap_serialize___discovery__Hello(soap, (const struct __discovery__Hello *)ptr);
		break;
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default___discovery__Probe(struct soap *soap, struct __discovery__Probe *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_wsdd__ProbeType(soap, &a->discovery__Probe);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___discovery__Probe(struct soap *soap, const struct __discovery__Probe *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_embedded(soap, &a->discovery__Probe, SOAP_TYPE_wsdd__ProbeType);
	soap_serialize_wsdd__ProbeType(soap, &a->discovery__Probe);
#endif
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out___discovery__Probe(struct soap *soap, const char *tag, int id, const struct __discovery__Probe *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_out_wsdd__ProbeType(soap, "discovery:Probe", -1, &a->discovery__Probe, ""))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __discovery__Probe * SOAP_FMAC4 soap_in___discovery__Probe(struct soap *soap, const char *tag, struct __discovery__Probe *a, const char *type)
{
	size_t soap_flag_discovery__Probe = 1;
	short soap_flag;
	(void)tag; (void)type; /* appease -Wall -Werror */
	a = (struct __discovery__Probe*)soap_id_enter(soap, "", a, SOAP_TYPE___discovery__Probe, sizeof(struct __discovery__Probe), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default___discovery__Probe(soap, a);
		for (soap_flag = 0;; soap_flag = 1)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_discovery__Probe && soap->error == SOAP_TAG_MISMATCH)
			{	if (soap_in_wsdd__ProbeType(soap, "discovery:Probe", &a->discovery__Probe, "wsdd:ProbeType"))
				{	soap_flag_discovery__Probe--;
					continue;
				}
			}
		...
		if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_discovery__Probe > 0))
...
{
	struct __discovery__Probe *p;
	struct __discovery__Probe *a = (struct __discovery__Probe*)soap_malloc((soap), (n = (n < 0 ? 1 : n)) * sizeof(struct __discovery__Probe));
	for (p = a; p && n--; p++)
		soap_default___discovery__Probe(soap, p);
	return a;
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put___discovery__Probe(struct soap *soap, const struct __discovery__Probe *a, const char *tag, const char *type)
{
	if (soap_out___discovery__Probe(soap, tag ? tag : "-discovery:Probe", -2, a, type))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __discovery__Probe * SOAP_FMAC4 soap_get___discovery__Probe(struct soap *soap, struct __discovery__Probe *p, const char *tag, const char *type)
{
	if ((p = soap_in___discovery__Probe(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default___discovery__Bye(struct soap *soap, struct __discovery__Bye *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_wsdd__ByeType(soap, &a->discovery__Bye);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___discovery__Bye(struct soap *soap, const struct __discovery__Bye *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_embedded(soap, &a->discovery__Bye, SOAP_TYPE_wsdd__ByeType);
	soap_serialize_wsdd__ByeType(soap, &a->discovery__Bye);
#endif
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out___discovery__Bye(struct soap *soap, const char *tag, int id, const struct __discovery__Bye *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_out_wsdd__ByeType(soap, "discovery:Bye", -1, &a->discovery__Bye, ""))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __discovery__Bye * SOAP_FMAC4 soap_in___discovery__Bye(struct soap *soap, const char *tag, struct __discovery__Bye *a, const char *type)
{
	size_t soap_flag_discovery__Bye = 1;
	short soap_flag;
	(void)tag; (void)type; /* appease -Wall -Werror */
	a = (struct __discovery__Bye*)soap_id_enter(soap, "", a, SOAP_TYPE___discovery__Bye, sizeof(struct __discovery__Bye), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default___discovery__Bye(soap, a);
		for (soap_flag = 0;; soap_flag = 1)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_discovery__Bye && soap->error == SOAP_TAG_MISMATCH)
			{	if (soap_in_wsdd__ByeType(soap, "discovery:Bye", &a->discovery__Bye, "wsdd:ByeType"))
				{	soap_flag_discovery__Bye--;
					continue;
				}
			}
			if (soap->error == SOAP_TAG_MISMATCH && soap_flag)
		...
		if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_discovery__Bye > 0))
		{	soap->error = SOAP_OCCURS;
			return NULL;
		}
	return a;
...
{
	struct __discovery__Bye *p;
	struct __discovery__Bye *a = (struct __discovery__Bye*)soap_malloc((soap), (n = (n < 0 ? 1 : n)) * sizeof(struct __discovery__Bye));
	for (p = a; p && n--; p++)
		soap_default___discovery__Bye(soap, p);
	return a;
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put___discovery__Bye(struct soap *soap, const struct __discovery__Bye *a, const char *tag, const char *type)
{
	if (soap_out___discovery__Bye(soap, tag ? tag : "-discovery:Bye", -2, a, type))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __discovery__Bye * SOAP_FMAC4 soap_get___discovery__Bye(struct soap *soap, struct __discovery__Bye *p, const char *tag, const char *type)
{
	if ((p = soap_in___discovery__Bye(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default___discovery__Hello(struct soap *soap, struct __discovery__Hello *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_wsdd__HelloType(soap, &a->discovery__Hello);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___discovery__Hello(struct soap *soap, const struct __discovery__Hello *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_embedded(soap, &a->discovery__Hello, SOAP_TYPE_wsdd__HelloType);
	soap_serialize_wsdd__HelloType(soap, &a->discovery__Hello);
#endif
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out___discovery__Hello(struct soap *soap, const char *tag, int id, const struct __discovery__Hello *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_out_wsdd__HelloType(soap, "discovery:Hello", -1, &a->discovery__Hello, ""))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __discovery__Hello * SOAP_FMAC4 soap_in___discovery__Hello(struct soap *soap, const char *tag, struct __discovery__Hello *a, const char *type)
{
	size_t soap_flag_discovery__Hello = 1;
	short soap_flag;
	(void)tag; (void)type; /* appease -Wall -Werror */
	a = (struct __discovery__Hello*)soap_id_enter(soap, "", a, SOAP_TYPE___discovery__Hello, sizeof(struct __discovery__Hello), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default___discovery__Hello(soap, a);
		for (soap_flag = 0;; soap_flag = 1)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_discovery__Hello && soap->error == SOAP_TAG_MISMATCH)
			{	if (soap_in_wsdd__HelloType(soap, "discovery:Hello", &a->discovery__Hello, "wsdd:HelloType"))
				{	soap_flag_discovery__Hello--;
					continue;
				}
			}
			if (soap->error == SOAP_TAG_MISMATCH && soap_flag)
		...
		if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_discovery__Hello > 0))
		{	soap->error = SOAP_OCCURS;
			return NULL;
		}
	return a;
...
{
	struct __discovery__Hello *p;
	struct __discovery__Hello *a = (struct __discovery__Hello*)soap_malloc((soap), (n = (n < 0 ? 1 : n)) * sizeof(struct __discovery__Hello));
	for (p = a; p && n--; p++)
		soap_default___discovery__Hello(soap, p);
	return a;
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put___discovery__Hello(struct soap *soap, const struct __discovery__Hello *a, const char *tag, const char *type)
{
	if (soap_out___discovery__Hello(soap, tag ? tag : "-discovery:Hello", -2, a, type))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __discovery__Hello * SOAP_FMAC4 soap_get___discovery__Hello(struct soap *soap, struct __discovery__Hello *p, const char *tag, const char *type)
{
	if ((p = soap_in___discovery__Hello(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}
